//! this is an optimization of experiment 3
//! we consider that the possible characters for a domain name are alphanumerical,
//! '-', '.', '*' and '_' (underscore is not in the spec but unfortunately appears
//! in the wild).
//! With this set of characters, we can encode keys on 6 bits, and hopefully get faster
//! matching.
//! It does not support wildcard matching yet.
